...
HcalHardcodeCalibrations::HcalHardcodeCalibrations(const edm::ParameterSet&
                                                   iConfig): he_recalibration(0), hf_recalibration(0) {
    edm::LogInfo("HCAL") <<
                         "HcalHardcodeCalibrations::HcalHardcodeCalibrations->...";

    if (iConfig.exists("GainWidthsForTrigPrims")) {
        switchGainWidthsForTrigPrims =
            iConfig.getParameter<bool>("GainWidthsForTrigPrims");
    }
    else {
    ...
    if (iLumi > 0.0) {
        ...
        if (hf_recalib) {
            hf_recalibration = new HFRecalibration();
        }
    ...
    if (relabel_) {
        ...
        edm::ParameterSet ps1 =
            ps0.getUntrackedParameter<edm::ParameterSet>("RelabelRules");
        for (int i = 0; i < 29; i++) {
            char name[10];
    ...
    std::vector <std::string> toGet = iConfig.getUntrackedParameter
                                      <std::vector <std::string> > ("toGet");
    for (std::vector <std::string>::iterator objectName = toGet.begin();
            objectName != toGet.end(); ++objectName) {
        ...
        if ((*objectName == "ChannelQuality") || (*objectName == "channelQuality")
                || all) {
            setWhatProduced(this, &HcalHardcodeCalibrations::produceChannelQuality);
            findingRecord <HcalChannelQualityRcd> ();
        }
        if ((*objectName == "ElectronicsMap") || (*objectName == "electronicsMap")
                || all) {
        ...
        if ((*objectName == "RespCorrs") || (*objectName == "ResponseCorrection")
                || all) {
        ...
        if ((*objectName == "L1TriggerObjects") || (*objectName == "L1Trigger")
                || all) {
            setWhatProduced(this, &HcalHardcodeCalibrations::produceL1TriggerObjects);
            findingRecord <HcalL1TriggerObjectsRcd> ();
        }
        if ((*objectName == "ValidationCorrs")
                || (*objectName == "ValidationCorrection") || all) {
...
HcalHardcodeCalibrations::~HcalHardcodeCalibrations() {
    ...
    if (hf_recalibration != 0) {
        delete hf_recalibration;
    }
}
...
//
void
HcalHardcodeCalibrations::setIntervalFor(const
                                         edm::eventsetup::EventSetupRecordKey& iKey, const edm::IOVSyncValue& iTime,
                                         edm::ValidityInterval& oInterval) {
    std::string record = iKey.name();
    edm::LogInfo("HCAL") << "HcalHardcodeCalibrations::setIntervalFor-> key: " <<
                         record << " time: " << iTime.eventID() << '/' << iTime.time().value();
    oInterval = edm::ValidityInterval(edm::IOVSyncValue::beginOfTime(),
                                      edm::IOVSyncValue::endOfTime()); //infinite
}

std::auto_ptr<HcalPedestals> HcalHardcodeCalibrations::producePedestals(
    ...
    for (std::vector <HcalGenericDetId>::const_iterator cell = cells.begin();
            cell != cells.end(); cell++) {
...
std::auto_ptr<HcalPedestalWidths>
HcalHardcodeCalibrations::producePedestalWidths(const HcalPedestalWidthsRcd&
                                                rec) {
...
std::auto_ptr<HcalGains> HcalHardcodeCalibrations::produceGains(
    const HcalGainsRcd& rec) {
...
std::auto_ptr<HcalGainWidths> HcalHardcodeCalibrations::produceGainWidths(
    const HcalGainWidthsRcd& rec) {
...
std::auto_ptr<HcalQIEData> HcalHardcodeCalibrations::produceQIEData(
    const HcalQIEDataRcd& rcd) {
...
std::auto_ptr<HcalChannelQuality>
HcalHardcodeCalibrations::produceChannelQuality(const HcalChannelQualityRcd&
                                                rcd) {
...
std::auto_ptr<HcalRespCorrs> HcalHardcodeCalibrations::produceRespCorrs(
    const HcalRespCorrsRcd& rcd) {
...
std::auto_ptr<HcalLUTCorrs> HcalHardcodeCalibrations::produceLUTCorrs(
    const HcalLUTCorrsRcd& rcd) {
...
std::auto_ptr<HcalPFCorrs> HcalHardcodeCalibrations::producePFCorrs(
    const HcalPFCorrsRcd& rcd) {
...
std::auto_ptr<HcalTimeCorrs> HcalHardcodeCalibrations::produceTimeCorrs(
    const HcalTimeCorrsRcd& rcd) {
...
std::auto_ptr<HcalZSThresholds> HcalHardcodeCalibrations::produceZSThresholds(
    const HcalZSThresholdsRcd& rcd) {
...
std::auto_ptr<HcalL1TriggerObjects>
HcalHardcodeCalibrations::produceL1TriggerObjects(const HcalL1TriggerObjectsRcd&
                                                  rcd) {
    edm::LogInfo("HCAL") <<
...
std::auto_ptr<HcalElectronicsMap>
HcalHardcodeCalibrations::produceElectronicsMap(const HcalElectronicsMapRcd&
                                                rcd) {
...
std::auto_ptr<HcalValidationCorrs>
HcalHardcodeCalibrations::produceValidationCorrs(const HcalValidationCorrsRcd&
                                                 rcd) {
    edm::LogInfo("HCAL") <<
...
std::auto_ptr<HcalLutMetadata> HcalHardcodeCalibrations::produceLutMetadata(
    const HcalLutMetadataRcd& rcd) {
...
std::auto_ptr<HcalDcsMap> HcalHardcodeCalibrations::produceDcsMap(
    const HcalDcsMapRcd& rcd) {
...
std::auto_ptr<HcalRecoParams> HcalHardcodeCalibrations::produceRecoParams(
    const HcalRecoParamsRcd& rec) {
...
std::auto_ptr<HcalTimingParams> HcalHardcodeCalibrations::produceTimingParams(
    const HcalTimingParamsRcd& rec) {
...
std::auto_ptr<HcalLongRecoParams>
HcalHardcodeCalibrations::produceLongRecoParams(const HcalLongRecoParamsRcd&
                                                rec) {
...
std::auto_ptr<HcalZDCLowGainFractions>
HcalHardcodeCalibrations::produceZDCLowGainFractions(const
                                                     HcalZDCLowGainFractionsRcd& rec) {
    edm::LogInfo("HCAL") <<
    ...
    std::auto_ptr<HcalZDCLowGainFractions> result(new HcalZDCLowGainFractions(
                                                      topo));
    std::vector <HcalGenericDetId> cells = allCells(*topo);
    for (std::vector <HcalGenericDetId>::const_iterator cell = cells.begin();
            cell != cells.end(); cell++) {
...
std::auto_ptr<HcalMCParams> HcalHardcodeCalibrations::produceMCParams(
    const HcalMCParamsRcd& rec) {
...
std::auto_ptr<HcalFlagHFDigiTimeParams>
HcalHardcodeCalibrations::produceFlagHFDigiTimeParams(const
                                                      HcalFlagHFDigiTimeParamsRcd& rec) {
    edm::LogInfo("HCAL") <<
...
std::auto_ptr<HcalCholeskyMatrices>
HcalHardcodeCalibrations::produceCholeskyMatrices(const HcalCholeskyMatricesRcd&
                                                  rec) {
...
std::auto_ptr<HcalCovarianceMatrices>
HcalHardcodeCalibrations::produceCovarianceMatrices(const
                                                    HcalCovarianceMatricesRcd& rec) {
