...
process.out = cms.OutputModule( "PoolOutputModule",
    fileName = cms.untracked.string("./AShortFileContainingAllCurrentlyAvailableQuantitiesFromRun200091.root"),
    SelectEvents = cms.untracked.PSet( SelectEvents = cms.vstring('p') ),
    outputCommands = cms.untracked.vstring( 
        'keep *_*simHcalTriggerPr*_*_*','keep *_*_*Forward*_*','keep *_*_*Central*_*'
       # 'keep *'
        )
